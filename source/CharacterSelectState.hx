...
class CharacterSelectState extends MusicBeatState
{
	...
	[
		...
		new CharacterInSelect(['sunflower'], [2, 0.5, 0.5, 0.5], ["Sunflower"]),
		new CharacterInSelect(['peashooter'], [0.25, 0.25, 2, 2], ["Peashooter"]),
		new CharacterInSelect(['snow-pea'], [0, 0, 3, 0], ["Mr. Snow Pea"]),
		new CharacterInSelect(['peashooter-angey'], [2, 2, 0.25, 0.25], ["3D Peashooter"]),
		new CharacterInSelect(['sunflower-golden'], [0.25, 0.25, 0.25, 2], ["Golden Sunflower"])
	];
	public function new() 
	{
		super();
	...
	override public function create():Void 
	{
		...
		var gate:FlxSprite = new FlxSprite(-225, 47).loadGraphic(Paths.image('peashooter/gate_night'));
		...
		var stageFront:FlxSprite = new FlxSprite(-225, 40).loadGraphic(Paths.image('peashooter/grass_night'));
