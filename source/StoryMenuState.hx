...
class StoryMenuState extends MusicBeatState
{
	...
	var weekNames:Array<String> = [
		...
		"Peashooter's Fun Rapping Battle!",
		"Mr. Snow Pea's Fun Corn Maze!",
		"The Finale",
		'?????????'
	];
	...
	override function create()
	{
		...
		//daveimage = new FlxSprite(0,56).loadGraphic(Paths.image("peashooter/storyModeBGDave"));
			...
			new FlxTimer().start(1, function(tmr:FlxTimer)
			{
				...
				switch (PlayState.storyWeek)
				{
					...
					case 7:
						...
						LoadingState.loadAndSwitchState(new VideoState('assets/videos/peashooterCutscene.webm', new PlayState()), true);
				}
	...
	function imageBgCheck()
	{
		...
		{
			case 7:
				path = Paths.image("peashooter/PeashooterHouse", "shared");
				position = new FlxPoint(600, 55);
			case 8:
				path = Paths.image("peashooter/snowball", "shared");
				position = new FlxPoint(600, 55);
			case 9:
				path = Paths.image("peashooter/splitathon", "shared");
				position = new FlxPoint(600, 55);
			default:
