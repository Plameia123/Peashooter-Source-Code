...
class Character extends FlxSprite
{
	...
	public var nativelyPlayable:Bool = true;
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'peashooter':
				...
				tex = Paths.getSparrowAtlas('peashooter/peashooter_sheet');
				frames = tex;
				animation.addByPrefix('idle', 'Peashooter Idle', 24, true);
				animation.addByPrefix('singUP', 'Peashooter Sing Up', 24, false);
				animation.addByPrefix('singRIGHT', 'Peashooter Sing Right', 24, false);
				animation.addByPrefix('singDOWN', 'Peashooter Sing Down', 24, false);
				animation.addByPrefix('singLEFT', 'Peashooter Sing Left', 24, false);

				addOffset('idle');
				addOffset("singUP", -13, -4);
				addOffset("singRIGHT", -22, -4);
				addOffset("singLEFT", 25, -4);
			...
			case 'peashooter-annoyed':
				// DAVE SHITE ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('peashooter/Peashooter_insanity');
				frames = tex;
				animation.addByPrefix('idle', 'Peashooter Idle', 24, true);
				animation.addByPrefix('singUP', 'Peashooter Sing Up', 24, false);
				animation.addByPrefix('singRIGHT', 'Peashooter Sing Right', 24, false);
			...
			case 'peashooter-angey':
				// DAVE SHITE ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('peashooter/Peashooter_Furiosity');
				frames = tex;
			...
			case 'snow-pea':
				frames = Paths.getSparrowAtlas('snow_pea/snowpeaRemake');
				animation.addByPrefix('idle', 'Idle', 24, true);
				animation.addByPrefix('singDOWN', 'down', 24, false);
				animation.addByPrefix('singUP', 'up', 24, false);
				animation.addByPrefix('singLEFT', 'left', 24, false);
			...
			case 'snowpea-3d':
				...
				tex = Paths.getSparrowAtlas('peashooter/snowpea_angryboy');
				frames = tex;
				animation.addByPrefix('idle', 'DaveAngry idle dance', 24, true);
				animation.addByPrefix('singUP', 'DaveAngry Sing Note UP', 24, true);
				animation.addByPrefix('singRIGHT', 'DaveAngry Sing Note RIGHT', 24, true);
				animation.addByPrefix('singDOWN', 'DaveAngry Sing Note DOWN', 24, true);
				animation.addByPrefix('singLEFT', 'DaveAngry Sing Note LEFT', 24, true);
			...
			case 'peashooter-splitathon':
				frames = Paths.getSparrowAtlas('splitathon/Splitathon_Peashooter');
				animation.addByPrefix('idle', 'Idle', 24, true);
				animation.addByPrefix('singDOWN', 'Down', 24, false);
				animation.addByPrefix('singUP', 'Up', 24, false);
				animation.addByPrefix('singLEFT', 'Left', 24, false);
				...
				addOffset("singRIGHT", -10, -3);
				addOffset("singLEFT", 9, -2);
				addOffset("singDOWN", -4, -4);

				playAnim('idle');

			case 'snowpea-splitathon':
				frames = Paths.getSparrowAtlas('splitathon/Splitathon_SnowPea');
				animation.addByPrefix('idle', 'Idle', 24, true);
			...
			case 'snowpea-old':
				var tex = Paths.getSparrowAtlas('peashooter/snowpea-old');
				frames = tex;
				animation.addByPrefix('idle', 'MARCELLO idle dance', 24, true);
			...
			case 'sunflower':
				var tex = Paths.getSparrowAtlas('peashooter/SUNFLOWER');
				frames = tex;
			...
			case 'sunflower-golden':
				var tex = Paths.getSparrowAtlas('peashooter/Sunflower_Golden');
				frames = tex;
			...
			case 'snowpea-angey':
				frames = Paths.getSparrowAtlas('snow_pea/snowpeamad');
				animation.addByPrefix('idle', 'idle', 24, true);
				animation.addByPrefix('singLEFT', 'left', 24, false);
				animation.addByPrefix('singDOWN', 'down', 24, false);
				animation.addByPrefix('singUP', 'up', 24, false);
